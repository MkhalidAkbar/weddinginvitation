(function(){
  ...
  function libThumb(it){
    ...
    var bakedCaption=(it.style==='modern-editorial'||it.style==='luxury-gold'||it.style==='garden-botanical');
    return '<div class="lib-shot'+(bakedCaption?' baked-caption':'')+'" style="background:linear-gradient(160deg,'+esc(cream)+','+esc(blush)+')">'
      +'<img class="lib-img" src="images/thumbs/'+esc(it.style)+'.webp?v=20260806" alt="Tampilan depan '+esc(it.name)+'" loading="lazy" decoding="async" onload="this.parentElement.classList.add(\'has-image\')" onerror="this.remove()">'
      +'<div class="lib-cap">'
