(function(){
  ...
  var LIBRARY=[
    ...
    {id:'luxury-gold',name:'Luxury Gold',style:'luxury-gold',paletteId:'classic-gold',kind:'frame',tags:['Art Deco','Imperial','Ballroom'],tagline:'Kemewahan art deco bernuansa obsidian dan champagne gold — double frame, medali geometris, cahaya ballroom, serta komposisi imperial yang dramatis.',mk:{bg1:'#181208',bg2:'#070604',ink:'#f3e9d2',acc:'#d9b45a',acc2:'#8d6425'},theme:{cream:'#181208',ink:'#f3e9d2',gold:'#d9b45a',sage:'#8d6425',blush:'#070604'}},
    ...
    {id:'kintsugi-nocturne',name:'Kintsugi Nocturne',style:'kintsugi-nocturne',paletteId:'urushi-gold',kind:'minimal',tags:['Kintsugi','Japanese','Sculptural'],tagline:'Kemewahan Jepang yang tenang dan artistik — scroll asimetris, ensō, patahan keramik berlapis emas, shoji portrait, lacquer tray countdown, ema wishes, dan gift box urushi.',theme:{cream:'#f2ede3',ink:'#171918',gold:'#ba8c39',sage:'#6e7569',blush:'#a95243'}},
    {id:'palais-astral',name:'Palais Astral',style:'palais-astral',paletteId:'midnight-orbit',kind:'circle',tags:['Celestial','Observatory','Regal'],tagline:'Perayaan celestial bergaya observatorium kerajaan — orrery cover, radial dome hero, planetary portrait, orbital countdown, constellation story, crystal gallery, dan celestial admission.',theme:{cream:'#eee9df',ink:'#101528',gold:'#b7a36a',sage:'#41596f',blush:'#8b6b78'}},
    {id:'ivory-letterpress',name:'Aurelia Letterpress',style:'ivory-letterpress',paletteId:'ivory-emboss',kind:'minimal',tags:['Letterpress','Stationery','Heirloom'],tagline:'Undangan elegan seperti stationery letterpress warisan — cotton paper bertekstur, blind emboss, wax seal, facing-page portrait, reply card, printed memories, dan correspondence book.',theme:{cream:'#f4efe4',ink:'#2e2924',gold:'#a88a5e',sage:'#747b6b',blush:'#d8cec0'}},
    {id:'porcelaine-bleue',name:'Porcelaine Bleue',style:'porcelaine-bleue',paletteId:'cobalt-ivory',kind:'circle',tags:['Porcelain','Cobalt','French'],tagline:'Keanggunan porselen Prancis berwarna cobalt — display plate cover, toile scenery, portrait medallion, tile countdown, blue-ribbon story, souvenir cabinet, dan carte de réponse.',theme:{cream:'#f7f4ec',ink:'#17345c',gold:'#b49a62',sage:'#58708f',blush:'#dbe4ec'}},
    {id:'eclat-nocturne',name:'Éclat Nocturne',style:'eclat-nocturne',paletteId:'obsidian-champagne',kind:'diamond',tags:['High Jewelry','Noir','Private Salon'],tagline:'Ultra-premium private jewelry salon — obsidian lacquer, champagne metal, faceted jewel cover, principal-stone portraits, watch countdown, provenance story, jewel cabinet, dan private appointment suite.',theme:{cream:'#f1eadb',ink:'#0a0c0f',gold:'#c7a86a',sage:'#284c45',blush:'#6e3f4c'}},
    {id:'casa-travertina',name:'Casa Travertina',style:'casa-travertina',paletteId:'travertine-silk',kind:'arch',tags:['Quiet Luxury','Travertine','Private Residence'],tagline:'Ultra-premium quiet-luxury residence — travertine facade, brass arch cover, architectural floor-plan hero, resident portraits, colonnade countdown, private collection, linen guest book, dan house treasury.',theme:{cream:'#e9e0d2',ink:'#363029',gold:'#a8895d',sage:'#6f745f',blush:'#c7ad9d'}},
    {id:'dahlia-aurea',name:'Dahlia Aurea',style:'dahlia-aurea',paletteId:'saffron-dahlia',kind:'circle',tags:['Dahlia','Maximal Floral','Warm Botanical'],tagline:'Taman bunga penuh bergaya floral tapestry — dahlia berlapis, zinnia, marigold, amaranthus, full-bloom cover, petal countdown, garland story, flower-hall events, dan woven floral gallery.',theme:{cream:'#f5ead7',ink:'#4b2b24',gold:'#c38a42',sage:'#6f7150',blush:'#d26f4f'}},
    {id:'iris-cascade',name:'Iris Cascade',style:'iris-cascade',paletteId:'indigo-iris',kind:'arch',tags:['Iris','Wisteria','Water Garden'],tagline:'Taman bunga penuh bernuansa air — iris Jepang, wisteria, delphinium, cascading canopy, water-garden cover, ripple countdown, flowing story, floral pavilions, dan floating flower gallery.',theme:{cream:'#f1efe8',ink:'#233052',gold:'#a9986e',sage:'#6f7f7b',blush:'#7f7eb4'}},
    {id:'camellia-rouge',name:'Camellia Rouge',style:'camellia-rouge',paletteId:'rouge-camellia',kind:'circle',tags:['Camellia','Magnolia','Velvet Floral'],tagline:'Floral tapestry mewah bergaya Camellia Rouge — camellia beludru, magnolia porselen, ranunculus, freesia, velvet-bloom cover, petal countdown, garland story, dan flower-hall celebration.',theme:{cream:'#f6ebe7',ink:'#4a2630',gold:'#b68a5b',sage:'#66705e',blush:'#bd5968'}},
    {id:'poppy-solstice',name:'Poppy Solstice',style:'poppy-solstice',paletteId:'vermilion-poppy',kind:'circle',tags:['Poppy','Cosmos','Sunlit Floral'],tagline:'Floral tapestry cerah penuh gerak — poppy vermilion, cosmos, anemone, sweet pea, sunlit-bloom cover, wildflower countdown, garland story, dan botanical celebration.',theme:{cream:'#f4ecd9',ink:'#392c28',gold:'#d6a13e',sage:'#697555',blush:'#d9583d'}}
  ];
  ...
  var TPL_PALETTES={
    ...
    'wedding-gazette':[
      {id:'press-red',name:'Press Red',colors:{cream:'#f5f0e6',ink:'#151515',gold:'#b2261f',sage:'#315947',blush:'#d9c8aa'}},
      {id:'blue-daily',name:'Blue Daily',colors:{cream:'#f3efe5',ink:'#102c42',gold:'#c03a2b',sage:'#607b77',blush:'#d5c6ae'}},
      {id:'forest-edition',name:'Forest Edition',colors:{cream:'#f1ead9',ink:'#17372d',gold:'#c16632',sage:'#6d7d5b',blush:'#d8cbb1'}},
      {id:'plum-press',name:'Plum Press',colors:{cream:'#f5ecdf',ink:'#3d2432',gold:'#9b3f4a',sage:'#79606f',blush:'#dec9bd'}}
    ],
    'pixel-love':[
      {id:'neon-arcade',name:'Neon Arcade',colors:{cream:'#090723',ink:'#f7f4ff',gold:'#ff3cac',sage:'#20e3d4',blush:'#34246f'}},
      {id:'cyber-lime',name:'Cyber Lime',colors:{cream:'#071b18',ink:'#effff8',gold:'#d8ff4f',sage:'#21d4a7',blush:'#154b45'}},
      {id:'sunset-console',name:'Sunset Console',colors:{cream:'#24102f',ink:'#fff1e8',gold:'#ff6b6b',sage:'#ffb84d',blush:'#5f275f'}},
      {id:'blue-player',name:'Blue Player',colors:{cream:'#07152f',ink:'#eef6ff',gold:'#4f8cff',sage:'#39e3ff',blush:'#173d78'}}
    ],
    'bauhaus-love':[
      {id:'primary-stage',name:'Primary Stage',colors:{cream:'#f4efe3',ink:'#111111',gold:'#e44132',sage:'#175bb8',blush:'#f2c84b'}},
    ...
    'maison-amour':[
      {id:'ivory-soiree',name:'Ivory Soirée',colors:{cream:'#f6f0e6',ink:'#1c1916',gold:'#b89a68',sage:'#8d7b6a',blush:'#ddd0bf'}},
      {id:'rose-champagne',name:'Rose Champagne',colors:{cream:'#fbf4ef',ink:'#2d2222',gold:'#c49a7a',sage:'#9f7d78',blush:'#ead5cf'}},
      {id:'sage-atelier',name:'Sage Atelier',colors:{cream:'#f3f2e9',ink:'#24302b',gold:'#b49968',sage:'#788b7b',blush:'#dfe3d8'}},
      {id:'midnight-silk',name:'Midnight Silk',colors:{cream:'#18191c',ink:'#f1eadf',gold:'#c5a56d',sage:'#6f7780',blush:'#27262c'}}
    ],
    'linea-vow':[
      {id:'vermillion-grid',name:'Vermillion Grid',colors:{cream:'#f2f1ed',ink:'#171717',gold:'#d24b33',sage:'#727772',blush:'#d7d5ce'}},
      {id:'cobalt-index',name:'Cobalt Index',colors:{cream:'#f1f2ef',ink:'#15191d',gold:'#2155c7',sage:'#657484',blush:'#d5dae0'}},
      {id:'olive-proof',name:'Olive Proof',colors:{cream:'#f3f0e7',ink:'#25261f',gold:'#8b4b32',sage:'#68705c',blush:'#d8d4c4'}},
      {id:'inverse-noir',name:'Inverse Noir',colors:{cream:'#171717',ink:'#f1f0eb',gold:'#f05a43',sage:'#8a8d88',blush:'#2b2b2b'}}
    ],
    'opaline-reverie':[
      {id:'pearl-dawn',name:'Pearl Dawn',colors:{cream:'#f8f4ef',ink:'#353039',gold:'#bc986d',sage:'#9aa9a6',blush:'#d9c8d4'}},
    ...
    'kintsugi-nocturne':[
      {id:'urushi-gold',name:'Urushi Gold',colors:{cream:'#f2ede3',ink:'#171918',gold:'#ba8c39',sage:'#6e7569',blush:'#a95243'}},
      {id:'celadon-mend',name:'Celadon Mend',colors:{cream:'#eef1e9',ink:'#1f2c29',gold:'#b89a59',sage:'#82988c',blush:'#b6c4b9'}},
      {id:'vermilion-tea',name:'Vermilion Tea',colors:{cream:'#f3e9dc',ink:'#2c1c17',gold:'#bd8d3f',sage:'#786f56',blush:'#bd4f3c'}},
      {id:'ivory-sumi',name:'Ivory Sumi',colors:{cream:'#f5f1e8',ink:'#111313',gold:'#9b7c43',sage:'#777b75',blush:'#b4aca0'}}
    ],
    'palais-astral':[
      {id:'midnight-orbit',name:'Midnight Orbit',colors:{cream:'#eee9df',ink:'#101528',gold:'#b7a36a',sage:'#41596f',blush:'#8b6b78'}},
      {id:'sapphire-eclipse',name:'Sapphire Eclipse',colors:{cream:'#edf0f2',ink:'#0c1c35',gold:'#b99e62',sage:'#28567a',blush:'#6d8197'}},
      {id:'aubergine-nebula',name:'Aubergine Nebula',colors:{cream:'#f0e9ed',ink:'#211226',gold:'#c2a56d',sage:'#59445f',blush:'#8b617c'}},
      {id:'ivory-solstice',name:'Ivory Solstice',colors:{cream:'#f5f0e5',ink:'#312d29',gold:'#b48c4f',sage:'#8b8978',blush:'#c4a99b'}}
    ],
    'ivory-letterpress':[
      {id:'ivory-emboss',name:'Ivory Emboss',colors:{cream:'#f4efe4',ink:'#2e2924',gold:'#a88a5e',sage:'#747b6b',blush:'#d8cec0'}},
      {id:'sage-letter',name:'Sage Letter',colors:{cream:'#f2efe5',ink:'#34382f',gold:'#a18b63',sage:'#697460',blush:'#d9d6c8'}},
      {id:'dusty-rose-press',name:'Dusty Rose Press',colors:{cream:'#f6f0e9',ink:'#493837',gold:'#aa846d',sage:'#927a72',blush:'#dfc9c4'}},
      {id:'charcoal-cotton',name:'Charcoal Cotton',colors:{cream:'#eeeae2',ink:'#232323',gold:'#9b8765',sage:'#686964',blush:'#d1cbc0'}}
    ],
    'porcelaine-bleue':[
      {id:'cobalt-ivory',name:'Cobalt Ivory',colors:{cream:'#f7f4ec',ink:'#17345c',gold:'#b49a62',sage:'#58708f',blush:'#dbe4ec'}},
      {id:'celadon-blue',name:'Celadon Blue',colors:{cream:'#f4f5ef',ink:'#254c57',gold:'#ad986e',sage:'#6f9492',blush:'#dce8e3'}},
      {id:'royal-sapphire',name:'Royal Sapphire',colors:{cream:'#f4f2ea',ink:'#102e61',gold:'#b69658',sage:'#405f8e',blush:'#d4deeb'}},
      {id:'rose-chinoiserie',name:'Rose Chinoiserie',colors:{cream:'#f8f2ee',ink:'#4c4059',gold:'#b48a6a',sage:'#77809a',blush:'#e4d2d8'}}
    ],
    'eclat-nocturne':[
      {id:'obsidian-champagne',name:'Obsidian Champagne',colors:{cream:'#f1eadb',ink:'#0a0c0f',gold:'#c7a86a',sage:'#284c45',blush:'#6e3f4c'}},
      {id:'emerald-bijoux',name:'Emerald Bijoux',colors:{cream:'#eee8da',ink:'#071511',gold:'#d1b36c',sage:'#1e4b3b',blush:'#6e5146'}},
      {id:'garnet-caviar',name:'Garnet Caviar',colors:{cream:'#f0e6dc',ink:'#14090c',gold:'#caa071',sage:'#5c4137',blush:'#752b3f'}},
      {id:'platinum-sapphire',name:'Platinum Sapphire',colors:{cream:'#e9ebef',ink:'#090d18',gold:'#bac1cc',sage:'#29466b',blush:'#4a3d63'}}
    ],
    'casa-travertina':[
      {id:'travertine-silk',name:'Travertine Silk',colors:{cream:'#e9e0d2',ink:'#363029',gold:'#a8895d',sage:'#6f745f',blush:'#c7ad9d'}},
      {id:'mocha-cashmere',name:'Mocha Cashmere',colors:{cream:'#e8ddd0',ink:'#3c3029',gold:'#a67d50',sage:'#75685b',blush:'#b99a86'}},
      {id:'olive-marble',name:'Olive Marble',colors:{cream:'#e8e5d9',ink:'#30362f',gold:'#9d8758',sage:'#687059',blush:'#c2b7a3'}},
      {id:'rose-champagne',name:'Rose Champagne',colors:{cream:'#eee3df',ink:'#493936',gold:'#ac8663',sage:'#82766e',blush:'#c8a6a1'}}
    ],
    'dahlia-aurea':[
      {id:'saffron-dahlia',name:'Saffron Dahlia',colors:{cream:'#f5ead7',ink:'#4b2b24',gold:'#c38a42',sage:'#6f7150',blush:'#d26f4f'}},
      {id:'burgundy-zinnia',name:'Burgundy Zinnia',colors:{cream:'#f1e4da',ink:'#4a2029',gold:'#b58755',sage:'#657052',blush:'#b84e5d'}},
      {id:'terracotta-marigold',name:'Terracotta Marigold',colors:{cream:'#f4e6d5',ink:'#563025',gold:'#c57932',sage:'#777451',blush:'#d8783c'}},
      {id:'plum-amaranth',name:'Plum Amaranth',colors:{cream:'#eee3df',ink:'#3f2436',gold:'#b28a59',sage:'#626a55',blush:'#a24f6a'}}
    ],
    'iris-cascade':[
      {id:'indigo-iris',name:'Indigo Iris',colors:{cream:'#f1efe8',ink:'#233052',gold:'#a9986e',sage:'#6f7f7b',blush:'#7f7eb4'}},
      {id:'wisteria-mist',name:'Wisteria Mist',colors:{cream:'#f3eff2',ink:'#423651',gold:'#aa906c',sage:'#75837a',blush:'#a989b3'}},
      {id:'celadon-delphinium',name:'Celadon Delphinium',colors:{cream:'#edf1eb',ink:'#29434b',gold:'#a79062',sage:'#6f8d82',blush:'#6685aa'}},
      {id:'moonlit-lavender',name:'Moonlit Lavender',colors:{cream:'#eeeaf1',ink:'#2d2b45',gold:'#a58c6c',sage:'#687675',blush:'#8d719f'}}
    ],
    'camellia-rouge':[
      {id:'rouge-camellia',name:'Rouge Camellia',colors:{cream:'#f6ebe7',ink:'#4a2630',gold:'#b68a5b',sage:'#66705e',blush:'#bd5968'}},
      {id:'porcelain-magnolia',name:'Porcelain Magnolia',colors:{cream:'#f7f0e9',ink:'#443439',gold:'#b39768',sage:'#77816f',blush:'#d2aaa6'}},
      {id:'wine-ranunculus',name:'Wine Ranunculus',colors:{cream:'#f0e4e4',ink:'#3e202c',gold:'#b18459',sage:'#65715f',blush:'#984359'}},
      {id:'tea-camellia',name:'Tea Camellia',colors:{cream:'#f4e8df',ink:'#52372f',gold:'#b98b55',sage:'#74765e',blush:'#c87970'}}
    ],
    'poppy-solstice':[
      {id:'vermilion-poppy',name:'Vermilion Poppy',colors:{cream:'#f4ecd9',ink:'#392c28',gold:'#d6a13e',sage:'#697555',blush:'#d9583d'}},
      {id:'apricot-cosmos',name:'Apricot Cosmos',colors:{cream:'#f6ead8',ink:'#493229',gold:'#cf9847',sage:'#727c62',blush:'#e38a62'}},
      {id:'burgundy-anemone',name:'Burgundy Anemone',colors:{cream:'#f1e5dd',ink:'#3d292c',gold:'#bd9250',sage:'#68735d',blush:'#98433f'}},
      {id:'indigo-sweetpea',name:'Indigo Sweet Pea',colors:{cream:'#eee9dd',ink:'#2d3344',gold:'#b99c59',sage:'#687967',blush:'#777aa0'}}
    ]
  };
  ...
  function libThumb(it){
    ...
    var darkThumb=(it.style==='modern-editorial'||it.style==='luxury-gold'||it.style==='midnight-luxe'||it.style==='javanese-heritage'||it.style==='cinematic-film'||it.style==='vinyl-romance'||it.style==='maison-amour'||it.style==='linea-vow'||it.style==='velours-royale'||it.style==='palais-astral'||it.style==='eclat-nocturne');
    return '<div class="lib-shot '+(darkThumb?'thumb-dark':'thumb-light')+'" style="background:linear-gradient(160deg,'+esc(cream)+','+esc(blush)+')">'
      +'<img class="lib-img" src="images/thumbs/'+esc(it.style)+'-dynamic.webp?v=20260807-29" alt="Latar template '+esc(it.name)+'" loading="lazy" decoding="async" onload="this.parentElement.classList.add(\'has-image\')" onerror="this.remove()">'
