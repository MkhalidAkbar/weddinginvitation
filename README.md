...
## Optimasi aset (2026-08-03)

- Ornamen flora dan thumbnail template memakai WebP.
- Aset duplikat di root telah dihapus; gunakan folder `images/`.
- Gambar galeri non-hero memakai lazy loading dan decoding asynchronous.
- `netlify.toml` memiliki cache header untuk HTML, JavaScript, dan aset gambar.
- Saat menambah ornamen baru, simpan sebagai WebP/AVIF dan hindari duplikasi file.


## Struktur modular (2026-08-03)

- CSS halaman dipindahkan ke `assets/css/`.
- JavaScript inline dipindahkan ke `assets/js/` dengan urutan eksekusi tetap sama.
- HTML sekarang berisi struktur dan referensi aset sehingga lebih ringan diparse.
- File CSS/JS dapat disimpan browser di cache dan digunakan ulang saat reload.
- Pertahankan urutan tag `<script>` karena beberapa plugin bergantung pada core halaman.
